...
namespace {
struct qt_meta_tag_ZN13ProductWindowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13ProductWindowE = QtMocHelpers::stringData(
    "ProductWindow",
    "handleUpdate",
    "",
    "row",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13ProductWindowE[] = {
...
Q_CONSTINIT const QMetaObject ProductWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13ProductWindowE.offsetsAndSizes,
    qt_meta_data_ZN13ProductWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13ProductWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *ProductWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13ProductWindowE.stringdata0))
