...
#include <QDateTime>
#include "Order_2.h"  // Assuming you have an Order class that represents an order
...
public:
    ...
    explicit DetailOrderWindow(const Order_2& order, QWidget* parent = nullptr);
...
private:
    ...
    Order_2 order;  // Member variable to store the order data
};
